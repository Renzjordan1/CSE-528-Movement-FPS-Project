...
public class CustomBulletEnemy : MonoBehaviour
{
    [Header("References")]
    public Rigidbody rb;
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if(collision.collider.CompareTag("Player") && explodeOnTouch && explodable) Explode();

        //Non-explodable collision
        else if(collision.collider.CompareTag("Player") && !explodable){
